 ...
 *
 */
public class GetBillingCountDrug extends ClinicRequest {
	private static final String FUNCTION_NAME = "GetBillingCountDrug";

	public GetBillingCountDrug(Context context) {
		super(context);
	}
	...
	public void getBillingCountDrug(Date beginDate, Date endDate, RequestCallBack callBack) {
