...
public abstract class BaseRequest {
    ...
    // 请求参数
    private com.mdground.guest.api.base.RequestData data;
    private com.mdground.guest.api.base.RequestCallBack mCallBack;
    ...
    public BaseRequest(Context context) {
        this.data = new com.mdground.guest.api.base.RequestData();
    ...
    // 同步请求
    protected com.mdground.guest.api.base.ResponseData pocessSync(boolean hasEncrypt) {
        if (!ToolNetwork.isNetworkConnected(mContext)) {
            Toast.makeText(mContext, "请连接网络", Toast.LENGTH_SHORT).show();
            return null;
        }

        com.mdground.guest.api.base.ResponseData responseData = null;
        ...
        try {
            ...
            responseData = gson.fromJson(body, com.mdground.guest.api.base.ResponseData.class);
    ...
    protected String appSign(com.mdground.guest.api.base.RequestData data) {
    ...
    public com.mdground.guest.api.base.RequestData getData() {
        return data;
    }

    public void setData(com.mdground.guest.api.base.RequestData data) {
        this.data = data;
    }
    ...
    protected HttpClient getHttpsClient() {
        if (httpsClient == null) {
            try {
                ...
                SSLSocketFactory sf = new com.mdground.guest.api.base.BaseSSLSocketFactory(trustStore);
    ...
    public com.mdground.guest.api.base.RequestCallBack getRequestCallBack() {
        return mCallBack;
    }

    public void setRequestCallBack(com.mdground.guest.api.base.RequestCallBack mCallBack) {
    ...
    private class BaseTextHttpResponseHandler extends TextHttpResponseHandler {
        ...
        public void onStart() {
            com.mdground.guest.api.base.RequestCallBack callback = getRequestCallBack();
            if (callback == null) {
                return;
            }
            callback.onStart();
        ...
        public void onSuccess(int statusCode, Header[] headers, String responseString) {
            ...
            try {
                ...
                Gson gson = new GsonBuilder().create();
                com.mdground.guest.api.base.ResponseData mResponseData = gson.fromJson(responseString, com.mdground.guest.api.base.ResponseData.class);
