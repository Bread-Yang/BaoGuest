package com.mdground.guest.bean;

import java.math.BigDecimal;
import java.util.Date;

public class Clinic implements Cloneable{
	...
	public void setBookingBonus(int bookingBonus) {
	...
	public void setDrugAudit(boolean drugAudit) {
		DrugAudit = drugAudit;
	}
	...
	public void setModuleRequired(int moduleRequired) {
	...
	public void setNavigationScreen(int navigationScreen) {
	...
	public void setWorkBeginHour(int workBeginHour) {
		WorkBeginHour = workBeginHour;
	}
	...
	public void setUpdatedTicks(BigDecimal updatedTicks) {
